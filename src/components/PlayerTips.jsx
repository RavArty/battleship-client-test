...
export const PlayerTips = ({ hitsbyPlayer, hitsByComputer, startAgain, winner }) => {
	...
	//console.log({ numberOfSuccessfulHits });
	let gameOverPanel = (
		<div>
			<div className='tip-box-title'>Game Over!</div>
			<p className='player-tip'>{winner === "player" ? "Player win! 🎉" : "Player lose 😭. Better luck next time! "}</p>
	...
	return <div id='player-tips'>{winner ? gameOverPanel : tipsPanel}</div>;
};
